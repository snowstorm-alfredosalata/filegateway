...
curl -X JSON -H "Content-Type: application/json" -d "$write_request" http://127.0.0.1:8000/api/v1/write_document
...
curl -X JSON -H "Content-Type: application/json" -d "$get_request" http://127.0.0.1:8000/api/v1/read_document